...
def _dashboard_inner():
    ...
    # Build list of positions expiring within 30 minutes
    expiring_soon = []
    ...
    return render_template(
        ...
        avg_pnl_per_trade_cents=stats["avg_pnl_per_trade_cents"],
        best_trade_ticker=stats["best_trade_ticker"],
        best_trade_pnl_cents=stats["best_trade_pnl_cents"],
        worst_trade_ticker=stats["worst_trade_ticker"],
        worst_trade_pnl_cents=stats["worst_trade_pnl_cents"],
