...
def run_whale_strategy(
    ...
    results, scanned = scan(client, min_price=min_price, ticker_prefixes=prefix_list, min_volume=min_volume, max_markets=5000)
    log(f"  Found {len(results)} qualifying markets (scanned {scanned})")
